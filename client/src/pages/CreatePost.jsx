    ...
    <section className='max-w-7xl mx-auto'>
      ...
      <form className="mt-16 max-w-3xl" onSubmit={handleSubmit}>
        ...
        <div className='mt-5 flex gap-5'>
            <button type='button' className='text-white bg-gray-700 font-medium rounded-md text-sm w-full sm:w-auto px-5 py-2.5 text-center' onClick={generatImg}>
              {generatingImg ? 'Generating...' : 'Generate' }
            </button>
        </div>
        <div className='mt-10'>
          <p className='mt-2 text-[#666e75] text-[14px]'>
            Once you have created the image you can share it with the others in the community.
          </p>
